...
void DummySink::SetFFmpeg(VSFFmpeg* ffmpeg)
{
	m_ffmpeg = ffmpeg;
}
...
RtspClient::RtspClient(UsageEnvironment& env, char const* rtspURL, char const* sUser, char const* sPasswd, VSFFmpeg** ffmpeg) 
